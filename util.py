...
import numpy as np  # Adicionado o import de numpy
...
def plot_decision_regions(X, y, classifier, resolution=0.02):
    ...
    4. Sobrepõe os pontos de treinamento
    ...
    xx1, xx2 = np.meshgrid(  # Corrigido erro de duplicação
    ...
    for idx, cl in enumerate(np.unique(y)):
        plt.scatter(
            ...
            marker=markers[idx],
            label=f'Classe {cl}',
            edgecolors='black'  # Corrigido para evitar warnings
        )
